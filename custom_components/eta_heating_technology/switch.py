...
from custom_components.eta_heating_technology.api import Error, Object, Success, Value
...
async def async_setup_entry(
    ...
    for obj in chosen_objects:
        ...
        if sensor_type is not EtaSensorType.BINARY_SENSOR:
            continue
